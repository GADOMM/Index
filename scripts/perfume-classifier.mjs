export const PERFUME_CLASSIFIER_VERSION = "perfume-v7";
...
const EXCLUDED_PRODUCT = /(?:^| )(?:zestaw|set|coffret|gift set|tester|probka|sample|miniatura|decant|odlewka|refill|uzupelnienie|dezodorant|deodorant|antyperspirant|balsam|lotion|krem|cream|szampon|shampoo|odzywka|conditioner|mydlo|soap|zel pod prysznic|shower gel|olejek do ciala|body oil|mgielka|body mist|hair mist|body spray|after shave|aftershave|woda po goleniu|swieca|candle|dyfuzor|diffuser|home fragrance|perfumy do pomieszczen|perfumy do wnetrz|odswiezacz powietrza i tkanin|spray do tkanin|zawieszka zapachowa|zapachowa zawieszka|chusteczki przywracajace czern|plyn do plukania)(?: |$)/;
